    ...
    <div className="bg-white  shadow-md rounded-md">
      ...
      <div className="text-base mx-4">
        ...
        <p className="my-4 leading-6">
          ...
          expedita molestiae est, aliquid reprehenderit voluptates recusandae in
          animi excepturi fugiat quis? Eos perspiciatis voluptatem est voluptate
          molestias nam eius accusamus?
        </p>
        <p className="leading-6 my-4">
          ...
          dolorum optio id omnis accusantium similique repellendus saepe numquam
          praesentium consequuntur fugiat ipsam sit expedita consequatur aperiam
          minima, quis amet? Necessitatibus ipsa autem asperiores odio iure a
          animi, soluta eligendi pariatur ducimus perspiciatis tempora eaque
          praesentium? Sed, ipsum asperiores maiores beatae neque ipsa error
          expedita molestias.
        </p>
      </div>
      <div className="ml-4">
